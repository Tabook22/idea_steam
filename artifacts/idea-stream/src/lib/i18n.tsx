...
const messages = {
  en: {
    ...
    chooseMedia: "Capture or choose image/video",
    uploading: "Uploading...",
    uploadFailed: "The media upload failed. Please try again.",
    mediaTypeError: "Choose an image or video file.",
    mediaSizeError: "Videos and images must be smaller than 100 MB.",
  ...
  ar: {
    ...
    chooseMedia: "التقط أو اختر صورة أو فيديو",
    uploading: "جارٍ الرفع...",
    uploadFailed: "تعذر رفع الوسائط. حاول مرة أخرى.",
    mediaTypeError: "اختر ملف صورة أو فيديو.",
    mediaSizeError: "يجب أن يكون حجم الصورة أو الفيديو أقل من 100 ميجابايت.",
